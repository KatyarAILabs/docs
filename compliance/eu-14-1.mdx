...
**Why Implemented**  
This is one of the cornerstone requirements of the EU AI Act for high-risk systems. It ensures that AI does not operate with full autonomy in scenarios that could affect people’s health, safety, or fundamental rights. Without meaningful human oversight, organizations risk automation bias, undetected harmful decisions, loss of accountability, cascading failures, and severe legal exposure under the Regulation.
...
**Next**: [EU-14.2 – Ability to Override AI Decisions](/compliance/controls/eu-14-2)