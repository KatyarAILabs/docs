...
**Why Implemented**  
This provision ensures that humans can completely ignore, disable, or nullify AI outputs when they are unreliable, harmful, or inappropriate — preventing any reliance on dangerous or erroneous AI decisions. It is the ultimate safeguard in the oversight chain: if monitoring fails, overrides fail, and intervention is too late, humans must still have the ability to completely stop depending on the AI system. This protects against persistent risks from malfunctioning or compromised high-risk AI.
...
**Next**: [EU-9.1 – Risk Management System](/compliance/controls/eu-9-1)