...
**Why Implemented**  
Without a clear, up-to-date inventory of AI systems, organizations cannot effectively map risks, assign accountability, monitor performance, respond to incidents, or demonstrate due diligence to stakeholders or regulators. An AI inventory is the starting point for all subsequent risk management activities in the NIST RMF — without it, risk mapping, measurement, and governance remain blind and fragmented.
