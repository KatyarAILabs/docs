...
**Why Implemented**  
High-risk AI can behave unexpectedly, escalate risks rapidly, or enter unsafe states during operation. Real-time intervention capability allows humans to immediately halt the system when anomalies, malfunctions, or foreseeable misuse are detected — preventing harm to health, safety, fundamental rights, or critical infrastructure before damage occurs.
...
**Next**: [EU-14.4 – Stop Operation](/compliance/controls/eu-14-4)